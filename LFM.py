...
class MF_LFM(object):
    ...
    def learningLFM(self, ratings_mat, input_user_mat, input_movie_mat, enable_hybrid, features, learn_loops, alpha, lamb, criterion):
    ...
    def pred_one_user(self, user_id, report_run_time=False):
        start_time = time()
        out = dot(self.user_mat[user_id-1],self.movie_mat)
        if report_run_time:
